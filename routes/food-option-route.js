...
const foodOptionMongo = require('../controllers/mongoose/food-option-controller-mongo')

const router = express.Router()

router.get('/', DB_NAME == 'mongoDB' ? foodOptionMongo.getFoodOption : (req, res) => { res.status(200) })
